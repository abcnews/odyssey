...
(function (Date, undefined) {
    ...
    Date.parse = function (date) {
        ...
        //
        // Note (Colin Gourlay): The regex has been modified to make the colon in the timezone offset optional,
        // so it matches the DCTERMS publication dates on ABC News websites. Original:                                                    **
